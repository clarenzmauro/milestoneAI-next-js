      ...
      <header className="sticky top-0 z-50 border-b backdrop-blur-md" style={{ borderColor: 'var(--border-subtle)', backgroundColor: 'transparent' }}>
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4" aria-label="Primary">
          <div className="flex items-center space-x-4">
            <div className="text-lg font-semibold" style={{ color: 'var(--text-inverse)' }}>
              MilestoneAI
            </div>
          </div>
      ...
      <section className="relative overflow-hidden">
        <div className="relative mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl mb-4" style={{ color: 'var(--text-inverse)' }}>
              {plan ? `Goal: ${plan.goal}` : `Generating Your ${selectedDuration}-Day Plan`}
            </h1>
            <p className="max-w-2xl text-base sm:text-lg mx-auto" style={{ color: 'var(--text-secondary)' }}>
              {plan ? 'Track your progress and stay on top of your milestones' : 'Watch your personalized milestone plan come to life in real-time...'}
            </p>
          </div>
