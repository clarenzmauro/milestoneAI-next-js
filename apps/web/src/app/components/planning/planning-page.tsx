...
import { timelineOptions } from '../../config/timelineOptions';
...
const getCardStyles = (isSelected: boolean) => ({
  ...
  borderColor: isSelected ? 'var(--color-border,#E5E9ED)' : 'var(--border-subtle)',
...
export default function PlanningPage() {
  ...
  const [selectedTimeline, setSelectedTimeline] = useState<number | 'custom' | null>(null);
  ...
  return (
    <main className="relative overflow-hidden h-screen" style={{ backgroundColor: 'var(--bg-deep)' }}>
      <BackgroundGradients />
      ...
      <section className="relative overflow-hidden">
        <div className="relative mx-auto max-w-7xl px-6 py-12 text-center">
          ...
          <p className="mt-4 max-w-2xl text-base sm:text-lg mx-auto" style={{ color: 'var(--text-secondary)' }}>
            Set the duration that works best for you, and let MilestoneAI create your roadmap.
          </p>
        </div>
      </section>
